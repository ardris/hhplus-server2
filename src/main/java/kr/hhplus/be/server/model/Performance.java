...
public class Performance {
    ...
    public LocalTime getPerformanceTime() { return performanceTime; }
    public void setPerformanceTime(LocalTime performanceTime) { this.performanceTime = performanceTime; }
