...
public class QueueServiceImpl implements QueueService {
    ...
    private final Set<String> enqueuedUserSet = ConcurrentHashMap.newKeySet(); // 대기열 사용자 집합 ㄴet 사용으로 여러번 대기열 들어가는걸 방지하려고 함.
    private final AtomicInteger queuePositionCounter = new AtomicInteger(1); // 순서 지정입니다. atomic 은 여러 사용자가 들어와도 순서 보장할려고 썼습니다.
